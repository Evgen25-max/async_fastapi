...
class FilmWork(UUIDMixin, TimeStampedMixin):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                fields=['modified', 'id'],
                name='idx_film_work_modified_id',
            ),
        ]
...
class GenreFilmWork(UUIDMixin):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=['created', 'id'],
                name='idx_gfw_created_id',
            ),
            models.Index(
                fields=['genre', 'film_work'],
                name='idx_gfw_genre_id_film_work_id',
            ),
        ]
...
class PersonFilmWork(UUIDMixin):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(
                fields=['created', 'id'],
                name='idx_pfw_created_id',
            ),
            models.Index(
                fields=['person', 'film_work'],
                name='idx_pfw_person_id_film_work_id',
            ),
        ]
